...
const key_override_t backspace_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_SPACE, KC_BACKSPACE);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [Base] = LAYOUT_split_3x6_3(
      KC_ESC,  CH_Q,    CH_W,    CH_E,    CH_R,    CH_T,                               CH_Z,    CH_U,    CH_I,    CH_O,    CH_P,    TG(4),
      KC_CAPS_LOCK, CH_A,    LALT_T(CH_S),    LSFT_T(CH_D),    LCTL_T(CH_F),    CH_G,                               CH_H,    LCTL_T(CH_J),    LSFT_T(CH_K),    LALT_T(CH_L),    CH_SCLN, KC_TAB,
      TT(4), CH_Y,    CH_X,    CH_C,    CH_V,    CH_B,                               CH_N,    CH_M,    CH_COMM, CH_DOT,  CH_SLSH, MO(2),
                                          TT(1), KC_LEFT_SHIFT, KC_LEFT_CTRL,           KC_LEFT_ALT,  KC_SPACE,  KC_ENT
  ),

  [Numbers] = LAYOUT_split_3x6_3(
      KC_NO,  CH_UNDS,    CH_LABK,    CH_RABK,    CH_LPRN,    CH_RPRN,                               CH_LCBR,    CH_RCBR,    CH_LBRC,    CH_RBRC,    KC_NO,    KC_NO,
      KC_NO, CH_1,    CH_2,    CH_3,    CH_4,    CH_5,                               CH_6,    CH_7,    CH_8,    CH_9,    CH_0, KC_NO,
      KC_NO, CH_PLUS,    CH_MINS,    CH_ASTR,    CH_SLSH,    CH_EQL,                               CH_QUES,    CH_EXLM,    CH_COLN, CH_QUOT,  CH_PIPE, KC_NO,
  ...
  [Gaming] = LAYOUT_split_3x6_3(
      ...
      KC_CAPS_LOCK, CH_A,    CH_S,    CH_D,    CH_F,    CH_G,                               CH_H,    CH_J,    CH_K,    CH_L,    CH_SCLN, KC_TAB,
      TT(4), CH_Y,    CH_X,    CH_C,    CH_V,    CH_B,                               CH_N,    CH_M,    CH_COMM, CH_DOT,  CH_SLSH, KC_NO,
                                          KC_ENT, KC_LEFT_SHIFT, KC_SPACE,           KC_LEFT_ALT,  KC_SPACE,  KC_ENT
  ),
};
